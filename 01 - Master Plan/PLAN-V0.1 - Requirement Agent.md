...
| **T13 — Registro de corrida** | Un archivo por corrida: qué Agent Definition, qué pedido, qué consumió, qué produjo, qué Gates hubo, quién aprobó | Se reconstruye qué pasó leyendo solo el registro, sin mirar la consola | T5 |
