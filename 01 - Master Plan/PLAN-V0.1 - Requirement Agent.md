...
| **T8 — Formulario de Intake** | Campos fijos: qué se quiere, para qué, qué NO entra, techo de presupuesto. Cerrado. Implementado en software-factory-core/src/intake.py. | Un pedido sin techo declarado no arranca | T4 |
...
| **T10 — Cargador con validación** | Lee la Agent Definition y se niega a arrancar si falta un campo. Cerrado. Implementado en software-factory-core/src/agent_loader.py. | Borrando un campo a propósito, no arranca e indica cuál falta | T9 |
